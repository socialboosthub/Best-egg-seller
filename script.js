            ...
            docs.forEach(o => {
                ...
                <div class="mini-order" style="margin-bottom:10px; display:flex; flex-wrap:wrap;">
                    ...
                    <div style="width:100%; margin-top:10px; padding-top:10px; border-top:1px dashed #eee; display:flex; justify-content:flex-end;">
                     <button onclick="window.generateReceiptPDF(window.ordersDataMap['${o.id}'])" style="background:#FFEBEB; color:#D32F2F; border:none; padding:8px 15px; border-radius:6px; font-size:12px; font-weight:600; cursor:pointer;">
